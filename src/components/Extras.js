...
import Picture from '../images/a-woman-silhouette-doing-crossfit-upscaled.png'
                    ...
                    <AnimateOnScrollComponent
                        ...
                        <div className="laptop flex_box_center_center">
                            <svg viewBox="0 0 480 268" width="100%" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
                                ...
                                <path
                                    onTransitionEnd={handleTransitionEnd}
                                    className='laptop-lid' d={lidClose ? "M 70,240 l 341.6 0 l 52.17 0 l -434.7 0 l 52 0 z M 426,250 l -368.4 0 l -56.4 0 c 0 -8.46 8 -8.46 18.05 -8.46 l 443.6 0 c 19.7 0 18 8 18 8.5 l -56 0 z" : 'M 70,240 l 341.643 0 l 0 -215.73 l -341.643 0 l 0 215.73 z M 426,250 l -368.433 0 l 0 -231.663 c 0 -9.87 8.037 -18.048 18.048 -18.048 l 333.606 0 c 9.87 0 18.048 8.037 18.048 18.048 l 0 231.663 z'} />
                                <image
                                    href={Picture}
                                    className="screen-bg"
                                    x="70"
